...
public final class RemoteLibrarySettings {
    ...
    public static Settings load(Context context) {
        ...
        return new Settings(p.getString(URL, ""), decrypt(p.getString(TOKEN, "")), p.getBoolean(ENABLED, false));
    }
    ...
    private static SecretKey key() throws Exception {
        ...
        if(!store.containsAlias("FireRetroLibrary")){ KeyGenerator generator=KeyGenerator.getInstance("AES","AndroidKeyStore"); generator.init(256); generator.generateKey(); }
