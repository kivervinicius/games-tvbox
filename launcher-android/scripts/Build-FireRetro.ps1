...
$sourceFiles = @(
    ...
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\GameAction.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\InputDeviceType.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\InputManager.java'),
    ...
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\DeviceType.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\DeviceProfile.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\EmulatorProvider.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\RetroArchProvider.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\GamerDashboardState.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\StorageType.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\RomStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\BaseRomStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\AppStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\LegacyExternalStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\RemovableStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\UsbStorageStrategy.java'),
    (Join-Path $appRoot 'app\src\main\java\com\kiver\fireretro\RomStorageResolver.java'),
