...
public final class ControllerProfileTest {
    public static void main(String[] args) {
        ...
        if (!merged.contains("input_quit_gamepad_combo = \"4\"")) throw new AssertionError("quit combo was not enforced");
        if (!merged.contains("input_exit_emulator_btn = \"nul\"")) throw new AssertionError("direct exit button was not disabled");
